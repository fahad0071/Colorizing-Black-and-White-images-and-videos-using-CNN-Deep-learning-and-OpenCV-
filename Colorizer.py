...
class Colorizer:
    ...
    def processFrame(self):
        ...
        # call the model and set input to resized Lchannel that we just extracted in line 98-100
        ...
        self.imgOut = np.concatenate((channelL[:, :, np.newaxis], resultResized), axis=2)#as we have side by side images
